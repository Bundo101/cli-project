...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["'James Britton'"]
  spec.email         = ["'brittonjp@gmail.com'"]

  spec.summary       = %q{WMDB}
  spec.description   = %q{Worst movies ever according to Metacritic}
  spec.homepage      = "https://github.com/Bundo101/cli_project"
  spec.license       = "MIT"
